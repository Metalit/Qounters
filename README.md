...
- A source is a function that drives either the text, fill level, or color of a component. It is registered to a set of events and reevaluated each time any of the events occurs.
